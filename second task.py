...
btn_add = Button(root, text="+", font="Arial 19 bold", width=2, height=1, bg="pink", bd="10", padx=8, pady=5, command=addition)
btn_add.place(x=235, y=60)

btn_sub = Button(root, text="-", font="Arial 19 bold", width=2, height=1, bg="pink", bd="10", padx=8, pady=5, command=subtraction)
btn_sub.place(x=235, y=145)

btn_div = Button(root, text="÷", font="System 19 bold", bg="pink", bd="10", padx=10, pady=5, command=division)
btn_div.place(x=235, y=230)

btn_clear = Button(root, text="C", font="Arial 19 bold", bg="pink", bd="10", padx=10, pady=5, command=clear)
btn_clear.place(x=85, y=315)

btn_eq = Button(root, text="=", font="Arial 19 bold", bg="pink", bd="10", padx=10, pady=5, command=equal)
btn_eq.place(x=160, y=315)

btn_mul = Button(root, text="*", font="Arial 19 bold", bg="pink", bd="10", padx=8, pady=5, command=multiplication)
